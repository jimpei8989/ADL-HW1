...
from models.intent_classifier_bert import IntentClassifierBert
...
def main(args):
    ...
    if args.do_train:
        ...
        trainer.train(
            to_dataloader(
                IntentDataset.load(
                    config.dataset.dataset_dir / "train.json",
                    tokenizer=tokenizer,
            ...
            to_dataloader(
                IntentDataset.load(
                    config.dataset.dataset_dir / "eval.json",
                    tokenizer=tokenizer,
                    is_bert_tokenizer=True,
                ),
            ),
    ...
    if args.do_predict:
        ...
        predictions = trainer.predict(
            to_dataloader(
                IntentDataset.load(args.test_json, tokenizer=tokenizer, is_bert_tokenizer=True)
            )
        )
